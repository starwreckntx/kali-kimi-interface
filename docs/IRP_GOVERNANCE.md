...
| Tool integrity | manifest root of trust (F4) + per-invocation SHA-256 + realpath containment; fd-pinned exec + pre-exec re-hash on enforced tiers | PATH hijack, symlink, binary swap (boot + mid-session) |
